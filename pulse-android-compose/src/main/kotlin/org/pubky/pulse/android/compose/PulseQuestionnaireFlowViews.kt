 ...
 * Compose analog of Swift's `PulseQuestionnaireConsentView`,
 * `PulseQuestionnaireSuccessView`, and `PulseQuestionnaireProgressBar`. Internal —
 * composed by [PulseQuestionnaireFlowContainer].
 */
 ...
 */
@Composable
internal fun PulseQuestionnaireConsentView(
    title: String,
    message: String,
    acceptLabel: String,
    laterLabel: String,
 ...
 */
@Composable
internal fun PulseQuestionnaireSuccessView(
    title: String,
    message: String,
    doneLabel: String,
    onDone: () -> Unit,
 ...
 * and including the current index. Mirrors Swift's `PulseQuestionnaireProgressBar`.
 */
@Composable
internal fun PulseQuestionnaireProgressBar(current: Int, total: Int) {
