...
/**
 * All user-facing strings rendered by [PulseFeedbackView]. The Compose analog of
 * the Swift `PulseFeedbackStrings`.
 *
 ...
 * PulseFeedbackStrings.DEFAULT.with(header = "How can we help?")
 *
 ...
 * ```
 */
public data class PulseFeedbackStrings(
     ...
     * Swift's `PulseFeedbackStrings.with(header:…)`. Any argument left null keeps
    ...
    public companion object {
        /** The English defaults — the analog of Swift's `PulseFeedbackStrings.default`. */
        public val DEFAULT: PulseFeedbackStrings = PulseFeedbackStrings()
    }
}
