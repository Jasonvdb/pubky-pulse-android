 ...
 * the Swift `PulseQuestionnaireStrings`.
 *
 * Same convention as [PulseFeedbackStrings]: every field is a plain [String] so
 ...
 */
public data class PulseQuestionnaireStrings(
     ...
     * Swift's `PulseQuestionnaireStrings.with(...)`. Any argument left null keeps
    ...
    ): PulseQuestionnaireStrings = copy(
    ...
    public companion object {
        /** The English defaults — the analog of Swift's `PulseQuestionnaireStrings.default`. */
        public val DEFAULT: PulseQuestionnaireStrings = PulseQuestionnaireStrings()
    }
}
