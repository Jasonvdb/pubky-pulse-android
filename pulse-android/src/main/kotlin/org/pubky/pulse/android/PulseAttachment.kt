 ...
 * analog of Swift's `PulseAttachment`.
 *
 ...
 */
public class PulseAttachment private constructor(
    public val source: Source,
    public val name: String,
    public val contentType: String?,
) {
    /** Where the attachment's bytes come from. Mirrors Swift's `PulseAttachment.Source`. */
    ...
    public companion object {
         ...
         * `PulseAttachment(fileURL:name:contentType:)`.
         */
        public fun file(
            file: File,
            name: String? = null,
            contentType: String? = null,
        ): PulseAttachment = PulseAttachment(
         ...
         * derive). Mirrors Swift's `PulseAttachment(data:name:contentType:)`.
         */
        public fun bytes(
            bytes: ByteArray,
            name: String,
